...
export default function Index({ id, title, price, brand, category, video, image, stock, brandId, categoryId }) {
    ...
    return (
        <div className="detail">
            <h2><Link style={{textDecoration: 'none', color: 'black'}} to={`/category/${categoryId}`}>{category}</Link> / <Link style={{textDecoration: 'none', color: 'black'}} to={`/brands/${brandId}`}>{brand}</Link></h2>
            <br/>
            <div className="product-detail">
                ...
                <article>
                    <br/>
                    <h3><Link style={{textDecoration: 'none', color: 'black'}} to={`/brands/${brandId}`}>{brand}</Link></h3>
                    <br/>
                    <h1>{title}</h1>
                    <br/>
